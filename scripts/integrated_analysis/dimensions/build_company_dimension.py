...
COMPANIES: List[Company] = [
    ...
    Company(
        ...
        short_code="LEHNE",
        tier="T1_SUB",
        company_type="unverified",
        is_yates_sub=False,
        primary_trade_id=9,
        default_csi_section_id=51,
        notes="Earthwork (RABA quality only) - no ProjectSight/narrative evidence",
        parent_company_id=2,
    ...
    Company(
        ...
        tier="T1_SUB",
        company_type="secai_contractor",
        is_yates_sub=False,
        primary_trade_id=2,
        default_csi_section_id=6,
        notes="SECAI direct contractor for piping/welding - NOT Yates sub per narrative verification",
    ...
    Company(
        ...
        notes="Miscellaneous steel fabrication - no ProjectSight/narrative evidence",
        parent_company_id=2,
        parent_confidence="LOW",
        aliases=[
            "gateway",
    ...
    Company(
        ...
        primary_trade_id=2,
        default_csi_section_id=6,
        notes="Pre-engineered metal buildings - no ProjectSight/narrative evidence",
        parent_company_id=2,
        parent_confidence="LOW",
        aliases=[
            "star",
    ...
    Company(
        ...
        primary_trade_id=2,
        default_csi_section_id=6,
        notes="Steel fabrication (RABA quality only) - no ProjectSight/narrative evidence",
        parent_company_id=2,
        parent_confidence="LOW",
        aliases=[
            "veltri steel",
    ...
    Company(
        ...
        primary_trade_id=2,
        default_csi_section_id=6,
        notes="Steel fabrication - no ProjectSight/narrative evidence",
        parent_company_id=2,
        parent_confidence="LOW",
        aliases=[
            "trinity steel",
    ...
    Company(
        ...
        primary_trade_id=4,
        default_csi_section_id=26,
        notes="Drywall (PSI quality: 203 inspections) - no ProjectSight/narrative evidence",
        parent_company_id=2,
        parent_confidence="LOW",
    ...
    Company(
        ...
        primary_trade_id=4,
        default_csi_section_id=26,
        notes="Drywall engineering (PSI quality: 55 inspections) - no ProjectSight/narrative evidence",
        parent_company_id=2,
        parent_confidence="LOW",
    ...
    Company(
        ...
        company_type="yates_sub",
        is_yates_sub=True,
        primary_trade_id=5,  # Changed from 4 (drywall) to 5 (finishes/doors)
        default_csi_section_id=21,  # Changed to doors/hardware CSI
        notes="Doors and panels - confirmed in narratives (door status meetings, SGP panel work)",
        parent_company_id=2,
        parent_confidence="HIGH",
        full_name="AMTS Inc.",
        aliases=[
    ...
    Company(
        ...
        primary_trade_id=4,
        default_csi_section_id=26,
        notes="SECAI subcontractor for IMP/sheeting - NOT Yates sub per narrative verification",
        parent_company_id=None,
        parent_confidence=None,
    ...
    Company(
        ...
        primary_trade_id=4,
        default_csi_section_id=26,
        notes="Drywall and acoustical contractor - no ProjectSight/narrative evidence",
        parent_company_id=2,
        parent_confidence="LOW",
        aliases=[
            "marek",
    ...
    Company(
        ...
        primary_trade_id=4,
        default_csi_section_id=26,
        notes="Drywall/framing (PSI quality only) - no ProjectSight/narrative evidence",
        parent_company_id=2,
        parent_confidence="LOW",
        full_name="Chaparral",
        aliases=[
    ...
    Company(
        ...
        primary_trade_id=4,
        default_csi_section_id=26,
        notes="Drywall contractor - no ProjectSight/narrative evidence",
        parent_company_id=2,
        parent_confidence="LOW",
        aliases=[
            "csa drywall",
    ...
    Company(
        ...
        default_csi_section_id=13,
        notes="Insulation and fireproofing - no ProjectSight/narrative evidence",
        parent_company_id=2,
        parent_confidence="LOW",
        aliases=[
            "performance",
    ...
    Company(
        ...
        notes="Firestopping (RABA quality: 24 inspections) - no ProjectSight/narrative evidence",
        parent_company_id=2,
        parent_confidence="LOW",
    ...
    Company(
        ...
        primary_trade_id=7,
        default_csi_section_id=40,
        notes="Electrical contractor - no ProjectSight/narrative evidence",
        parent_company_id=2,
        parent_confidence="LOW",
        aliases=[
            "mcdean",
    ...
    Company(
        ...
        primary_trade_id=7,
        default_csi_section_id=40,
        notes="Mechanical contractor - no ProjectSight/narrative evidence",
        parent_company_id=2,
        parent_confidence="LOW",
        aliases=[
            "polk",
    ...
    Company(
        ...
        primary_trade_id=5,
        default_csi_section_id=23,
        notes="Door hardware installation - no ProjectSight/narrative evidence",
        parent_company_id=2,
        parent_confidence="LOW",
        aliases=[
            "alert",
    ...
    Company(
        ...
        notes="Flooring contractor - no ProjectSight/narrative evidence",
        parent_company_id=2,
        parent_confidence="LOW",
        aliases=[
            "spectra",
    ...
    Company(
        ...
        primary_trade_id=5,
        default_csi_section_id=29,
        notes="Specialty finishes - no ProjectSight/narrative evidence",
        parent_company_id=2,
        parent_confidence="LOW",
        aliases=[
            "texas scenic",
    ...
    Company(
        ...
        notes="Masonry contractor - no ProjectSight/narrative evidence",
        parent_company_id=2,
        parent_confidence="LOW",
        aliases=[
            "sbta",
    ...
    Company(
        ...
        primary_trade_id=12,
        default_csi_section_id=1,
        notes="Unverified - no ProjectSight/narrative evidence",
        parent_company_id=2,
        parent_confidence="LOW",
        aliases=["sti"],
    ),
    ...
    Company(
        ...
        primary_trade_id=12,
        default_csi_section_id=1,
        notes="Architect/Engineer of Record - NOT a contractor per narrative verification",
        parent_company_id=None,
        parent_confidence=None,
        aliases=["jacobs"],
    ),
    Company(
        ...
        primary_trade_id=12,
        default_csi_section_id=1,
        notes="Scaffolding contractor - confirmed in narratives (IOCC-919, CCD #382)",
        parent_company_id=2,
        parent_confidence="HIGH",
        aliases=["brandsafway"],
    ),
    Company(
        ...
        primary_trade_id=12,
        default_csi_section_id=1,
        notes="Korean subcontractor - no ProjectSight/narrative evidence",
        parent_company_id=2,
        parent_confidence="LOW",
        aliases=["shinsung"],
    ),
    ...
    Company(
        ...
        primary_trade_id=12,
        default_csi_section_id=1,
        notes="Industrial contractor - no ProjectSight/narrative evidence",
        parent_company_id=2,
        parent_confidence="LOW",
    ...
    Company(
        ...
        primary_trade_id=12,
        default_csi_section_id=1,
        notes="IT contractor - no ProjectSight/narrative evidence",
        parent_company_id=2,
        parent_confidence="LOW",
        aliases=["smart it"],
    ),
    Company(
        ...
        short_code="PRIME_CTRL",
        tier="T1_SUB",
        company_type="unverified",
        is_yates_sub=False,
        primary_trade_id=7,
        default_csi_section_id=40,
        notes="Controls contractor - no ProjectSight/narrative evidence",
        parent_company_id=2,
        parent_confidence="LOW",
        aliases=["prime controls"],  # Removed "prime" alias - conflicts with Prime Contractor
    ),
    Company(
        company_id=84,
        canonical_name="DSI",
        ...
        primary_trade_id=7,
        default_csi_section_id=40,
        notes="SECAI direct contractor (Dynamic Systems Inc) - NOT Yates sub per narrative verification",
        parent_company_id=None,
        parent_confidence=None,
        aliases=["dsi"],
    ),
    ...
    Company(
        ...
        primary_trade_id=12,
        default_csi_section_id=1,
        notes="Caulking contractor - no ProjectSight/narrative evidence (Berg does fire caulk)",
        parent_company_id=2,
        parent_confidence="LOW",
        aliases=["j-kaulk"],
    ),
    ...
    Company(
        ...
        short_code="MSRFSR",
        tier="OTHER",
        company_type="owner_qc",
        is_yates_sub=False,
        primary_trade_id=12,
        default_csi_section_id=1,
        notes="Samsung/SECAI QC entity - signs off on inspections, NOT a contractor",
        parent_company_id=None,
        parent_confidence=None,
        aliases=["msr-fsr"],
    ),
