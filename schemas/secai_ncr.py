...
class SecaiNcrConsolidated(BaseModel):
    ...
    expected_close_date: Optional[str] = Field(default=None, description="Expected close date")
    issued_by: Optional[str] = Field(default=None, description="Issued by")
    status: Optional[str] = Field(default=None, description="Status (Open/Closed) - External NCR only")
    action_completion_date: Optional[str] = Field(default=None, description="Action completion date")
    five_m_analysis: Optional[str] = Field(default=None, description="5M Analysis category")
    work_step: Optional[str] = Field(default=None, description="Work step description")
    cause_of_issue: Optional[str] = Field(default=None, description="Cause of issue")
    days_open: Optional[float] = Field(default=None, description="Days open")
    issuing_org: Optional[str] = Field(default=None, description="Issuing organization")
    action_pic: Optional[str] = Field(default=None, description="Action PIC (person in charge)")
    grade: Optional[str] = Field(default=None, description="Grade classification")
    action_days: Optional[float] = Field(default=None, description="Action days (time to resolve)")
    pic_leader: Optional[str] = Field(default=None, description="PIC Leader")
    delay: Optional[float] = Field(default=None, description="Delay indicator")
