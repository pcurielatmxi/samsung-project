...
class RabaPsiConsolidated(BaseModel):
    ...
    report_date_normalized: Optional[str] = Field(default=None, description="Normalized report date")
    ...
    location_id: Optional[float] = Field(default=None, description="Location ID (legacy)")
    outcome: Optional[str] = Field(default=None, description="Inspection outcome (PASS/FAIL)")
    failure_reason: Optional[float] = Field(default=None, description="Reason for failure")
    failure_category: Optional[float] = Field(default=None, description="Category of failure")
    summary: Optional[str] = Field(default=None, description="Inspection summary")
    tests_total: Optional[float] = Field(default=None, description="Total number of tests")
    tests_passed: Optional[float] = Field(default=None, description="Number of tests passed")
    tests_failed: Optional[float] = Field(default=None, description="Number of tests failed")
    deficiency_count: Optional[float] = Field(default=None, description="Count of deficiencies")
    reinspection_required: Optional[float] = Field(default=None, description="Whether reinspection required")
    corrective_action: Optional[float] = Field(default=None, description="Corrective action required")
    ...
    trade: Optional[float] = Field(default=None, description="Trade")
    issues: Optional[float] = Field(default=None, description="Issues JSON")
    ...
    building_level: Optional[float] = Field(default=None, description="Combined building-level")
    dim_company_id: Optional[float] = Field(default=None, description="FK to dim_company (contractor)")
    dim_subcontractor_id: Optional[float] = Field(default=None, description="FK to dim_company (subcontractor)")
    performing_company_id: Optional[float] = Field(default=None, description="FK to dim_company (performing)")
...
class RabaPsiDataQuality(BaseModel):
    ...
    """
    inspection_id: str = Field(description="Unique inspection identifier")
    level_raw: Optional[float] = Field(default=None, description="Raw level value")
    ...
    trade_raw: Optional[float] = Field(default=None, description="Raw trade value")
    ...
    affected_rooms: Optional[float] = Field(default=None, description="JSON array of affected rooms")
