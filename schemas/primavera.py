...
class P6TaskTaxonomy(BaseModel):
    ...
    area: Optional[float] = Field(default=None, description="Area code")
    room: Optional[float] = Field(default=None, description="Room code")
    sub_contractor: Optional[float] = Field(default=None, description="Subcontractor")
    ...
    impact_code: Optional[float] = Field(default=None, description="Impact code")
    impact_type: Optional[float] = Field(default=None, description="Impact type")
    impact_type_desc: Optional[float] = Field(default=None, description="Impact type description")
    attributed_to: Optional[float] = Field(default=None, description="Attributed to")
    attributed_to_desc: Optional[float] = Field(default=None, description="Attributed to description")
    root_cause: Optional[float] = Field(default=None, description="Root cause")
    root_cause_desc: Optional[float] = Field(default=None, description="Root cause description")
...
class P6TaskTaxonomyDataQuality(BaseModel):
    ...
    area_source: Optional[float] = Field(default=None, description="Source of area")
    room_source: Optional[float] = Field(default=None, description="Source of room")
    sub_source: Optional[float] = Field(default=None, description="Source of subcontractor")
    ...
    impact_source: Optional[float] = Field(default=None, description="Source of impact")
    csi_inference_source: Optional[str] = Field(default=None, description="Source of CSI inference")
